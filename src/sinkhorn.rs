...
pub fn sinkhorn(a: Array1< f32 >, b: Array1< f32 >, cost: Array2< f32 >, reg: f32, warm_u: Option< Array1< f32 > >) -> (Array2< f32 >, Array1< f32 >)
{
    let n = cost.nrows();
    let m = cost.ncols();
    ...
    let mut u = warm_u.unwrap_or(Array1::zeros(n));
